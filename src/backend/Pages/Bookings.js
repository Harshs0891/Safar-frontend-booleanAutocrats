...
const Bookings = () => {
  ...
  const loadUsers = async () => {
    ...
    const result = await axios.get("https://test-booking-production.up.railway.app/users");
  ...
  const deleteUser = async (id)=>{
    ...
    await axios.delete(`https://test-booking-production.up.railway.app/user/${id}`)
